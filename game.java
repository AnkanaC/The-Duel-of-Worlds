...
public class game
{
    String heroes[] =new String[]{"hercules","Jace Herondale","pikachu","jedi"};//list of characterss
    ...
    public void getPowers()
    {
        ...
        jace=new String[]{"face punch","rune attack","sword slash","heal"};
    ...
    public String JaceStrength()
    {
        String strength=""; 
        System.out.println();
        if(choice.equalsIgnoreCase("hero"))
        {
            //user input choice if the user is jace
            System.out.println("Choose your move :");
            for(int i=0;i<4;i++)
                System.out.println(jace[i]);
            strength=sc.nextLine();
        }
        else
        {
            //random generated move if jace is the opponent
            Random r=new Random();        
            int strengthnum =r.nextInt(jace.length);
            strength=jace[strengthnum]; 
        }
        System.out.println();
        return(strength);  
    }
    ...
    public String play()
    {
        ...
        while(true)
        {
            ...
            if(heroBot.equalsIgnoreCase("Jace"))
            {
                if(choice.equalsIgnoreCase("hero"))
                {
                    //if the move is user input
                    System.out.println("Your turn ");
                    move=JaceStrength();
                    if(move.equalsIgnoreCase("heal"))
                    {
                ...
                {
                    //if the move is random generated
                    System.out.println("Jace's turn ");
                    move=JaceStrength();
                    try
                    {
                        // Delay for 2 seonds
                    ...
                    System.out.println("Jace chose "+move);
                    if(move.equalsIgnoreCase("heal"))
                    {
                        Random r=new Random();        
                        int healthnum =r.nextInt(health.length);
                        Hhealth+=health[healthnum];
                        System.out.println("Jace's health increased by "+health[healthnum]);
                        try
                        {
                            // Delay for 2 seonds
                            Thread.sleep(2000);   
                        ...
                        System.out.println("Jace's health : "+Hhealth);
                        System.out.println(villainBot+"'s health : "+Vhealth);
                    }
                    else
                    {
                        ...
                        if(damage[attacknum]!=0)
                            System.out.println("Jace did "+damage[attacknum]+" damage to "+villainBot);
                        else
                            System.out.println("Oops Jace missed "+villainBot);
                        try
                        {
                            // Delay for 2 seonds
                            Thread.sleep(2000);   
